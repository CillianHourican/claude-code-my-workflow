...
description: Translates Beamer LaTeX slides to Quarto RevealJS format, handling content translation, environment mapping, citation conversion, and formatting.
