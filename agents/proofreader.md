---
name: proofreader
description: Proofreads academic lecture slides for grammar, typos, overflow risks, and consistency issues, producing a detailed report without editing files.
